            ...
            postRepo.saveAll(List.of(
                    new Post("about",
                            "重点实验室主要研究方向：\n" +
                                    ...
                                    "1. 新型纤维材料的开发与检测技术研究\n" +
                                    "\n" +
                                    "    通过深入地应用基础研究，揭示现有纺织材料及各种新型纺织材料的理化性能与大分子微观结构及超分子结构的内在关系，探寻某些特殊或新型纺织材料的性能特点，为新型纺织材料的开发及其后续应用提供理论支撑，配套研发新型纤维及制品检测技术、仪器。\n" +
                                    "\n" +
                                    "2. 先进纺织加工理论与清洁生产技术研究\n" +
                                    "\n" +
                                    "针对不同纤维特征及功能，运用数理、力学、表面科学等学科的新理论、新方法、新手段，研究以纤维体为基本单元的纤维集合体及复合体（含纺织预制件成型技术）的成型加工新理论和新技术，以实现不同纤维性能的充分利用和再生利用，同时对古代纺织技术及文化进行挖掘保护性研究。\n" +
                                    "\n",
                            "about", new String[]{}),
